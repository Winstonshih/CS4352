        ...
        nextButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
               ...
               //if all the information is complete
                ...
                editor.putLong("income", Long.parseLong(Income.getText().toString()));
                editor.putLong("Food", Long.parseLong(food.getText().toString()));
                editor.putLong("mortage", Long.parseLong(mortage.getText().toString()));
                editor.putLong("waterBill", Long.parseLong(waterBill.getText().toString()));
                editor.putLong("electricBill", Long.parseLong(electricBill.getText().toString()));
                editor.putLong("gasBill", Long.parseLong(gasBill.getText().toString()));
                editor.putLong("internetBill", Long.parseLong(internetBill.getText().toString()));
                editor.apply();
