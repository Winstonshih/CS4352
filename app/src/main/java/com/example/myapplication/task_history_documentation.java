...
public class task_history_documentation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        taskButton.setOnClickListener(v -> {
            // Navigate to SignUp activity
            Intent intent = new Intent(this, task_history_task_overview.class);
            startActivity(intent);
        });
        instructionsButton.setOnClickListener(v -> {
            // Navigate to SignUp activity
            Intent intent = new Intent(this, task_history_instructions.class);
            startActivity(intent);
        });
    }
}