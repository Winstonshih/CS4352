...
public class main_game_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new Item("Open a stock account", "Diamond Armor (+10 Protection)", R.drawable.upgradedarmor));
        items.add(new Item("Open a savings account", "Diamond pants (+10 Protection)", R.drawable.upgradedpants));
